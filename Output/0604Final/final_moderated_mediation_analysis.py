...
log_output(model_c1.summary().tables[1].to_string())
...
log_output(model_c2a.summary().tables[1].to_string())
...
log_output(model_c2b.summary().tables[1].to_string())
